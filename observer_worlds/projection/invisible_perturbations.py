...
# Projections whose output depends on which specific cells are ON:
# verify after each proposed perturbation.
_VERIFICATION_BASED = (
...
# ---------------------------------------------------------------------------
# Strategy 2: verification-based rejection sampling
# ---------------------------------------------------------------------------
